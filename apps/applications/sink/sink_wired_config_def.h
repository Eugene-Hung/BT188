...
#define SINK_WIRED_WRITEABLE_CONFIG_BLK_ID 1092
...
#define SINK_WIRED_READONLY_CONFIG_BLK_ID 1102
...
#define SPDIF_SETTINGS_CONFIG_BLK_ID 1113

typedef struct {
    spdif_configuration_t SpdifConfig;
} spdif_settings_config_def_t;

#define I2S_DATA_CONFIG_BLK_ID 1118
